...
def main():
    ...
    savings_interest = float(input("Please, enter the annual interest rate for the savings account (in %): "))
    ...
    print(f"The interest earned on the savings account is: ${savings_interest_earned:.2f}")
    ...
    cd_interest = float(input("Please, enter the annual interest rate for the CD account (in %): "))
